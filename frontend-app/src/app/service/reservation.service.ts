...
export class ReservationService {
  ...
  addReservation(): Observable<any> {
    return this.http.post<{ message: string, reservationId: string }>('http://localhost:4700/api/visitorData', this.reservation);
  }

  getReservations(dateFrom: any, dateTo: any): Observable<Reservation[]> {
    ...
    return this.http.get<Reservation[]>('http://localhost:4700/api/visitorData', { params });
  }
